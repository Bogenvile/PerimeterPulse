      ...
      <AlertDialogContent className="max-w-md">
        <AlertDialogHeader>
          ...
          <AlertDialogDescription className="text-sm leading-relaxed">
            Are you sure you want to delete <span className="font-semibold text-foreground">{hostname}</span>?
            This will permanently remove all metrics, locations, and error logs. This action cannot be undone.
          </AlertDialogDescription>
        </AlertDialogHeader>
